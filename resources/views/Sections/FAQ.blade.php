    ...
    <div class="faq_holder w_100 h_fc flex_cl mtop_5vh">
        <div class="faq_card w_100 h_10vh overflow_hidden">
            ...
            <div class="answer w_100 grid col_middle_3 align_c justify_sb">
                ...
                <h4 class="font_w500 w_100">It depends on the visa type, but we usually prepare your application within 3–5 working days.</h4>
        ...
        <div class="faq_card w_100 h_10vh overflow_hidden">
            <div class="question w_100 h_10vh grid col_middle_3 align_c justify_sb">
             ...
             <div class="answer w_100 grid col_middle_3 align_c justify_sb">
                <h3 class="font_w500 w_100 question_title"></h3>
                <h4 class="font_w500 w_100 ">No one can guarantee a visa — but our experienced team gives you the best chance through preparation and accuracy.</h4>
                <h3 class="font_w500 w_100 flex justify_fe"></h3>
            </div>
        </div>
        <div class="faq_card w_100 h_10vh overflow_hidden">
            <div class="question w_100 h_10vh grid col_middle_3 align_c justify_sb">
             ...
             <div class="answer w_100 grid col_middle_3 align_c justify_sb">
                <h3 class="font_w500 w_100 question_title"></h3>
                <h4 class="font_w500 w_100">Yes, we offer a free first consultation.</h4>
                <h3 class="font_w500 w_100 flex justify_fe"></h3>
            </div>
        </div>
    </div>
